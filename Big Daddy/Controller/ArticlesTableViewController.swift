        ...
        articlesArray = [
            Article(keyword:"alcohol pregnancy uk us france australia official advice avoid serious shirley airplane mother&rsquo;s blood baby liver organ develop process drinking drink first three months increase risk miscarriage premature birth low weight developmental problems heavily regularly serious condition foetal syndrome facial abnormalities learning difficulties restricted growth worry risk low gone off taste small batch organic craft IPA friday night cup of tea G&T gin tonic cucumber lime spirit alcohol-free", name:"Alcohol"),
             ...
             Article(keyword:"miscarriage statistics bleeding pain cramping 12 weeks 23 risk smoking age drinking drugs caffeine obesity symptoms GP hospital medication surgery sex contraception emotion grief bereavement support recurrent counselling", name:"Miscarriage"),
              ...
              Article(keyword:"premature baby babies early pre term 24 37 weeks twins triplets induction c-section caesarian section pregnancy complications growth contractions waters break P-PROM labour rupture membranes infection antibiotics thermometer temperature quick risk developmental problems medical team don’t panic stay calm hold hand reassure neonatal unit incubator red skin downy hair lanugo supportive unsettling develop Tommy’s Tommys", name:"Premature Babies"),
              Article(keyword:"is it sex safe pregnancy bump braxton hicks contractions bleeding labour miscarriage anchorman octagon penis lost that loving feeling top gun", name:"Sex"),
