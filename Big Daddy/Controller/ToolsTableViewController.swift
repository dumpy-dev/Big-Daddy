//
//  ToolsTableTableViewController.swift
//  Big Daddy
//
//  Created by Georgie and Chris on 29/03/2018.
//  Copyright © 2018 Dumpy Developments. All rights reserved.
//

import UIKit

class ToolsTableTableViewController:UITableViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        toolsArray = ["Assisted Delivery","Caesarean Section","Drinking","Driving","Eating","Exercise","First Aid","Holidays","Migraines","Morning Sickness","Nose Bleeds","Postnatal Depression","Pre-eclampsia","Sleep Deprivation","Stretch Marks","Vitamin K","Vitamin Supplements"]
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let text = toolsArray[indexPath.row]
