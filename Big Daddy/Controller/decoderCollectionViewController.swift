...
// MARK:- Full copy for items and descriptions, and image array
        itemArray = [
            ...
            Item(itemName:"Long-sleeved vest", isEssential: true, itemDescription:"A handy halfway house between short sleeved vests and sleepsuits. With long sleeves but no legs, these are great at keeping that pesky nappy securely in place. They also look great under dungarees. Depending on the season, you’ll probably want half a dozen of these."),
