...
// MARK:- Full copy for items and descriptions
        itemArray = [
            ...
            Item(itemName:"Short-sleeved vest", isEssential: true, itemDescription:"The most-used baby garment out there. With no sleeves or legs, a baby vest is ideal for keeping that nappy in place. If it’s cold, layer under a sleepsuit or outfit. If it’s warm, wear on its own. You’ll need at least seven of these."), Item(itemName:"Long-sleeved vest", isEssential: true, itemDescription:"A handy halfway house between short sleeved vests and sleepsuits. With long sleeves but no legs, these are also great at keeping that pesky nappy securely in place. They also look great under dungarees. Depending on the season, you’ll probably want half a dozen of these."),
