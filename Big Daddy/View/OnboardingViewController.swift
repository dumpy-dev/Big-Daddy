...
class OnboardingViewController: UIViewController, SwiftyOnboardDataSource, SwiftyOnboardDelegate {
    ...
    var imageArray = [#imageLiteral(resourceName: "seahorse"), #imageLiteral(resourceName: "swipeToRight.png"), #imageLiteral(resourceName: "right-arrow"), #imageLiteral(resourceName: "articlesIcon"), #imageLiteral(resourceName: "toolsIcon"), #imageLiteral(resourceName: "controls")]
